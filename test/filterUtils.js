...
function renderProducts(listchose = [], listchose2 = [], searchTerm = '') {
    ...
    for (let i = 0; i < dataJson.length; i++) {
        ...
        <div class='course-item'>
            <a href="../Detail_Product/Detail.html?id=${product.id}"> <!-- Thêm liên kết đến trang chi tiết sản phẩm -->
            ...
            <div class="button-container">
                <a href="../Detail_Product/Detail.html?id=${product.id}" class="more-info">></a>
            </div>
        </div>
        `;
    }
